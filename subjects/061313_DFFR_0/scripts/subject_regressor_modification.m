...
for run = 1 : length(runs)
	if (run >= 1 && run <= 4) || run == 10
	   	% this should correspond to (5-8 )-1-1epilistblock OR 14-epiwordlocalizer and we want to add the last TR of the regressors list
	...
	if run == 11 % this should correspond to 15-1-1epiimage and we want to add a single, all-zeros TR to the regressors list
